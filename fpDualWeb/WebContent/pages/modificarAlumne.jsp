                    ...
                    <div class="col-lg-12 col-md-12">
                        <table class="table table-striped  table-hover">
                            	<tr>
									...
									<th width="16%"><input type="text" id="myNom" onkeyup="buscarNom()" placeholder="Filtrar per nom..." style="width:100%"></th>
									<th width="28.5%"><input type="text" id="myCog" onkeyup="buscarCog()" placeholder="Filtrar per cognom..." style="width:100%"></th>
									<th width="17%"><input type="text" id="myTut" onkeyup="buscarTut()" placeholder="Filtrar per tutor..." style="width:100%"></th>
