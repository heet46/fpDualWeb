...
<script type="text/javascript">
    ...
    if (g.selectedIndex==0)
      {
      alert("No s'ha seleccionat un centre.");
      return false;
      }
    }
    </script>
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper" >
            <div id="page-inner">
                <div class="row">
                    <div class="col-lg-12">
                     <h2><i id="imgTitol" class="fa fa-user-plus" aria-hidden="true">&nbsp;</i>Afegir responsable</h2>   
                    </div>
                </div>              
                 <!-- /. ROW  -->
                  <hr />
				...
				<script type="text/javascript">		        
					bootbox.alert("Ja existeix un usuari amb aquest NIF", function() {
				...
				<%} %>
                  <!-- /. ROW  --> 
                            <div class="row text-center pad-top">
                                <form method="post" name="Form" onsubmit="return validateForm()" action="/fpDualWeb/AfegirResponsable">
