...
<%@ page language="java" contentType="text/html; charset=ISO-8859-1"
	...
	<%
		...
		if (alumne == null || alumne == "") {
			...
			ConsultaSQL = " id_alumne LIKE '%" + alumne + "%'";
			contador = 1;
		}
		...
		if (activitat == null || activitat == "") {
			...
			if (contador == 0) {
				ConsultaSQL = " id_activitat LIKE '%" + activitat + "%'";
			} else {
				ConsultaSQL += " AND id_activitat LIKE '%" + activitat + "%'";
			}
			contador = 1;
		}
		...
		if (data == null || data == "") {
			...
			if (contador == 0) {
				ConsultaSQL = " data LIKE '%" + data + "%'";
			} else {
				ConsultaSQL += " AND data LIKE '%" + data + "%'";
			}
			contador = 1;
		}
