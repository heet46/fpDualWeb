    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper" >
            <div id="page-inner">
                <div class="row">
                    <div class="col-lg-12">
                     <h2><i id="imgTitol" class="fa fa-user-times" aria-hidden="true">&nbsp;</i>Baixa responsables</h2>   
                    </div>
                </div>              
                 <!-- /. ROW  -->
                  <hr />
                                                    ...
                                                    <tbody>
                                                        ...
                                                        %>
                                                        	<tr>
                                                        		...
                                                        		<td style="width: 10%">
                                                        			<form name="form" method="Post" action="../EliminarResponsable" class="table-link">
                                                        				<input type="hidden" name="NIF" value="<%=r.getNIF()%>">
                                                        				<input type="submit" class="btn btn-danger" value="Eliminar">
                                                        			</form>
                                                        		</td>
                                                        	</tr>
                                                        <% 	
                                                    	System.out.println(r.getNIF());
                                                        	}
                                                        %>
                                                    </tbody>
                                                </table>
